...
///////////////////////////////////////////////////////////////////////////////
// SizeAndTimeBasedRollingFileAppender ctors and dtor
///////////////////////////////////////////////////////////////////////////////
...
void SizeAndTimeBasedRollingFileAppender::rolloverbytime(bool alreadyLocked)
{
	helpers::LockFileGuard guard;
...
void SizeAndTimeBasedRollingFileAppender::rolloverbysize(bool alreadyLocked)
{
	//处理文件大小回滚
	helpers::LogLog & loglog = helpers::getLogLog();
	helpers::LockFileGuard guard;
...
helpers::Time::duration SizeAndTimeBasedRollingFileAppender::getRolloverPeriodDuration() const
{
	switch (schedule)
	{
	case MONTHLY:
	...
	default:
		helpers::getLogLog().error(
			LOG4CPLUS_TEXT("SizeAndTimeBasedRollingFileAppender::getRolloverPeriodDuration()-")
			LOG4CPLUS_TEXT(" invalid schedule value"));
		// Fall through.
	case DAILY:
		return std::chrono::hours{ 24 };
...
helpers::Time SizeAndTimeBasedRollingFileAppender::calculateNextRolloverTime(const helpers::Time & t) const
{
	return helpers::truncate_fractions(
		log4cplus::calculateNextRolloverTime(t, schedule));
}
