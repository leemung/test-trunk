...
namespace log4cplus
{
	...
	class LOG4CPLUS_EXPORT SizeAndTimeBaseRollingFileAppender : public FileAppenderBase {
	public:
		// Ctors
		SizeAndTimeBaseRollingFileAppender(const tstring& filename = LOG4CPLUS_TEXT(""),
			const tstring& filenamePattern = LOG4CPLUS_TEXT("%d.log"),
			...
			bool createDirs = false,
			bool rollOnClose = true);
		SizeAndTimeBaseRollingFileAppender(const helpers::Properties& properties);

		// Dtor
		~SizeAndTimeBaseRollingFileAppender();
